...
$arq=fopen("../../_ArquivosTXT/Checkin.txt","a") or die("Erro na crição do arquivo EMPENHOS.TXT");
...
$arq=fopen("../../_ArquivosTXT/Checkin.csv","a") or die("Erro na crição do arquivo EMPENHOS.CSV");
